...
This is known as maintaining symmetry, where "symmetry" here in math means the same as in regular language. The collection of these movements that yield a symmetry is known as a "group." Thus, a mathematical group contains the ways to preserve symmetry of a shape. The group for our table has a specific name (C<sub>4</sub>), and what's important to remember is that it doesn't just apply to our table; it applies *universally*, for *all* objects that have the same structural symmetries.[^frenkel] 
...
I know it's still abstract, but once it clicks, it becomes more engaging. That this was even possible is itself interesting when you consider the sheer scale of the task. I want to skip ahead to the very final point, which may feel a bit like jumping to end of a complex novel, yet also seems necessary to capture just what the Monster *is*.
...
Yes, this is the largest group. No, it's not known why there is nothing bigger. Yes, it seems arbitrary. No, it can't be arbitrary, because there's too many coincidences about it that align profoundly with seemingly unrelated areas of mathematics, such as number theory, modular forms, and string theory.[^moonshine]
...
Somewhere out there, Totoro is grinning in 196,883 dimensions, totally aware of what he's up to.
...
[^sources]: I'm taking the words at face value from two people deeply involved in the Monster, [John Conway](https://www.youtube.com/watch?v=xOCe5HUObD4) and [Richard Borcherds](https://www.youtube.com/watch?v=xu15ZbxxnUQ){target="_blank"}. [^moonshine]: Check out "monstrous moonshine."
