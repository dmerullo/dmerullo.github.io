...
- **NGS Analysis:** RNA-seq, single-cell sequencing, spatial transcriptomics, clustering (UMAP, tSNE), PCA, tree-based models, differential expression testing, linear regression, 10X Genomics Chromium, 10X Genomics Visium, Cell Ranger, Space Ranger, Seurat
