...
- Led a multi-group collaboration to publish large-scale single-cell RNA-seq datasets in neurobiology, producing a co-first-author paper in *Science* (145+ citations) and a second-author paper in *Nature Communications* (30+ citations)
- Independently analyzed large-scale single-cell RNA-seq data by applying computational pipelines, dataset integration, unsupervised clustering, and statistical modeling for 20,000 genes in 200,000+ cells across multiple brain regions, species, and cell types
...
- Produced five first-author publications, five conference poster presentations, and a nationally-competitive NSF Graduate Research Fellowship
