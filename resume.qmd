...
Biomedical data scientist experienced in bioinformatics, data pipeline development, and high-dimensional analytics. Skilled at translating large-scale biological data into functional insights through genomic data integration, single-cell and spatial multi-omics, interactive visualizations, scalable HPC/cloud workflows, and AI/ML applications. With expertise in data science and the life sciences, excels at cross-functional collaboration and problem-solving.
...
- Reduce latency of data delivery by 10x for a major pharmaceutical client by creating novel data ingestion pipelines in R, Python, and Bash
- Collaborate across the bioinformatics and data engineering teams to deliver thousands of genomic datasets (GWAS & xQTL) scaling to terabytes in size, driving biomarker discovery for drug development
...
- Lead a multi-group collaboration to publish the first single-cell RNA-seq dataset in birds, resulting in a co-first-author paper in *Science* (130+ citations) and a second-author paper in *Nature Communications* (25+ citations)
- Conducted large-scale transcriptomics analyses of gene expression levels for 20,000+ genes in 200,000+ individual cells across multiple brain regions, species, and experiments
- Awarded a competitive NIH Postdoctoral Fellowship (NRSA F32)
- Implemented end-to-end spatial transcriptomics from molecular to computational components
